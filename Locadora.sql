...
-- Copiando estrutura do banco de dados para dtb-locadora-rich
DROP DATABASE IF EXISTS `dtb-locadora`;
CREATE DATABASE IF NOT EXISTS `dtb-locadora` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `dtb-locadora-rich`;

-- Copiando estrutura para tabela dtb-locadora-rich.cidade
...
-- Copiando dados para a tabela dtb-locadora-rich.cidade: ~5.564 rows (aproximadamente)
...
-- Copiando estrutura para tabela dtb-locadora-rich.cliente
...
-- Copiando dados para a tabela dtb-locadora-rich.cliente: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `cliente` DISABLE KEYS */;
INSERT INTO `cliente` (`id_cliente`, `nome`, `cpf`, `rg`, `data_nascimento`, `idade`, `sexo`, `endereco_id_endereco`, `contato_id_contato`) VALUES
	(1, 'Fulano de Tal', '457.894.567-89', '45.678.941-2', '10/02/2000', 21, 'Masculino', 4, 4),
	(2, 'Criança de Tal', '753.456.123-48', '98.741.510-2', '10/04/2011', 10, 'Masculino', 5, 5);
/*!40000 ALTER TABLE `cliente` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-locadora-rich.contato
...
-- Copiando dados para a tabela dtb-locadora-rich.contato: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `contato` DISABLE KEYS */;
INSERT INTO `contato` (`id_contato`, `telefone`, `celular`, `email`) VALUES
	(1, '(11) 1111-1111', '(22) 22222-2222', 'admin@contato.com.br'),
	(2, '(33) 3333-3333', '(44) 44444-4444', 'desenvolvedor@contato.com.br'),
	(3, '(55) 5555-5555', '(66) 66666-6666', 'usuario@contato.com.br'),
	(4, '(77) 7777-7777', '(88) 88888-8888', 'fulano@contato.com.br'),
	(5, '(99) 9999-9999', '(45) 95645-6132', 'crianca@contato.com.br');
/*!40000 ALTER TABLE `contato` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-locadora-rich.endereco
...
-- Copiando dados para a tabela dtb-locadora-rich.endereco: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `endereco` DISABLE KEYS */;
INSERT INTO `endereco` (`id_endereco`, `tipo_logradouro`, `endereco`, `numero`, `complemento`, `bairro`, `cep`, `cidade_id_cidade`) VALUES
	(1, 'Avenida', 'Central', 123, 'Sala B', 'Centro', '1245-123', 1670),
	(2, 'Rua', '15 de Novembro', 654, 'Portão A', 'Vila Maria', '32165-498', 3373),
	(3, 'Acesso', 'Lateral', 654, 'KM 25', 'Vila Marginal', '42351-321', 700),
	(4, 'Alameda', 'Araguai', 850, 'Apto 25', 'Alphaville', '06456-789', 4770),
	(5, 'Avenida', '15 de Novembro', 987, '', 'Vila Maria', '45612-345', 206);
/*!40000 ALTER TABLE `endereco` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-locadora-rich.estado
CREATE TABLE IF NOT EXISTS `estado` (
  ...
  KEY `fk_estado_regiao1_idx` (`regiao_id_regiao`),
  CONSTRAINT `fk_estado_regiao1` FOREIGN KEY (`regiao_id_regiao`) REFERENCES `regiao` (`id_regiao`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela dtb-locadora-rich.estado: ~27 rows (aproximadamente)
...
-- Copiando estrutura para tabela dtb-locadora-rich.filme
...
-- Copiando dados para a tabela dtb-locadora-rich.filme: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `filme` DISABLE KEYS */;
INSERT INTO `filme` (`id_filme`, `nome`, `valor`, `disponivel`, `promocao`, `valor_promocao`, `diretor`, `ano_lancamento`, `faixa_etaria`, `genero`) VALUES
	(1, 'A Era do Gelo', 15.5, 'Sim', 'Sim', 10.25, 'Mark Zuquembergue', '2002', 10, 'Animação'),
	(2, 'A Lista de Schindler', 22, 'Sim', 'Não', NULL, 'Frank Martoso', '1998', 18, 'Arte'),
	(3, 'O Poderoso Chefão', 16, 'Sim', 'Sim', 13.65, 'Luiz Hermanem', '1980', 18, 'Ação'),
	(4, 'Um Sonho de Liberdade', 16, 'Sim', 'Sim', 11.45, 'Juliano Robert', '2005', 10, 'Drama'),
	(5, 'O Rei Leão', 10, 'Sim', 'Não', NULL, 'Suzana Marinho', '1991', 10, 'Animação'),
	(6, 'O Senhor dos Anéis - O Retorno do Rei', 16.5, 'Sim', 'Não', NULL, 'Gustavo Flavio Ramos', '2004', 16, 'Aventura'),
	(7, 'À Espera de Um Milagre', 5.5, 'Sim', 'Sim', 2.25, 'Otavio Lucas', '1993', 14, 'Drama');
/*!40000 ALTER TABLE `filme` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-locadora-rich.forma_pagamento
...
-- Copiando dados para a tabela dtb-locadora-rich.forma_pagamento: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela dtb-locadora-rich.funcionario
CREATE TABLE IF NOT EXISTS `funcionario` (
  ...
  `perfil_acesso` varchar(45) NOT NULL,
  `contato_id_contato` int NOT NULL,
  `endereco_id_endereco` int NOT NULL,
...
-- Copiando dados para a tabela dtb-locadora-rich.funcionario: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `funcionario` DISABLE KEYS */;
INSERT INTO `funcionario` (`id_funcionario`, `nome`, `cpf`, `rg`, `data_nascimento`, `idade`, `sexo`, `login`, `senha`, `perfil_acesso`, `contato_id_contato`, `endereco_id_endereco`) VALUES
	(1, 'Administrador do Sistema', '123.123.123-12', '12.123.123-1', '10/02/1980', 41, 'Masculino', 'admin', 'admin', 'Administrador', 1, 1),
	(2, 'Desenvolvedor do Sistema', '456.456.456-45', '75.378.657-5', '05/05/2000', 21, 'Masculino', 'dev', 'dev', 'Desenvolvedor', 2, 2),
	(3, 'Usuário do Sistema', '987.987.987-98', '65.465.465-4', '01/03/1990', 31, 'Masculino', 'user', 'user', 'Usuario', 3, 3);
/*!40000 ALTER TABLE `funcionario` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-locadora-rich.locacao
CREATE TABLE IF NOT EXISTS `locacao` (
  `id_locacao` int NOT NULL AUTO_INCREMENT,
  `data_locacao` varchar(45) NOT NULL,
  `data_devolucao` varchar(45) NOT NULL,
  `valor` double NOT NULL,
  `devolvido` varchar(45) NOT NULL,
  `funcionario_id_funcionario` int NOT NULL,
  `forma_pagamento_id_forma_pagamento` int NOT NULL,
  `cliente_id_cliente` int NOT NULL,
  PRIMARY KEY (`id_locacao`),
  KEY `fk_locacao_funcionario1_idx` (`funcionario_id_funcionario`),
  KEY `fk_locacao_forma_pagamento1_idx` (`forma_pagamento_id_forma_pagamento`),
  KEY `fk_locacao_cliente1_idx` (`cliente_id_cliente`),
  CONSTRAINT `fk_locacao_cliente1` FOREIGN KEY (`cliente_id_cliente`) REFERENCES `cliente` (`id_cliente`),
  CONSTRAINT `fk_locacao_forma_pagamento1` FOREIGN KEY (`forma_pagamento_id_forma_pagamento`) REFERENCES `forma_pagamento` (`id_forma_pagamento`),
  CONSTRAINT `fk_locacao_funcionario1` FOREIGN KEY (`funcionario_id_funcionario`) REFERENCES `funcionario` (`id_funcionario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela dtb-locadora-rich.locacao: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `locacao` DISABLE KEYS */;
/*!40000 ALTER TABLE `locacao` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-locadora-rich.locacao_filme
CREATE TABLE IF NOT EXISTS `locacao_filme` (
  `id_locacao_filme` int NOT NULL AUTO_INCREMENT,
  `filme_id_filme` int NOT NULL,
  `locacao_id_locacao` int NOT NULL,
  PRIMARY KEY (`id_locacao_filme`),
  KEY `fk_locacao_filme_filme1_idx` (`filme_id_filme`),
  KEY `fk_locacao_filme_locacao1_idx` (`locacao_id_locacao`),
  CONSTRAINT `fk_locacao_filme_filme1` FOREIGN KEY (`filme_id_filme`) REFERENCES `filme` (`id_filme`),
  CONSTRAINT `fk_locacao_filme_locacao1` FOREIGN KEY (`locacao_id_locacao`) REFERENCES `locacao` (`id_locacao`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela dtb-locadora-rich.locacao_filme: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `locacao_filme` DISABLE KEYS */;
/*!40000 ALTER TABLE `locacao_filme` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-locadora-rich.regiao
...
-- Copiando dados para a tabela dtb-locadora-rich.regiao: ~5 rows (aproximadamente)
