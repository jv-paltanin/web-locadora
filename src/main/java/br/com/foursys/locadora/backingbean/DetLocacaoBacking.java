...
public class DetLocacaoBacking implements Serializable {
	...
	public String getDevolveAux() {
		return devolveAux;
	}

	public void setDevolveAux(String devolveAux) {
		this.devolveAux = devolveAux;
	}
	...
	private void carregarTela() {
		...
		if (locacao.getDevolvido().equals("Sim")) {
			setDevolveAux("Sim");
		} else {
			setDevolveAux("Não");
		}
