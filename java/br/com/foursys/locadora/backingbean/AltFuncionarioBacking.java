...
public class AltFuncionarioBacking implements Serializable {
	...
	public void carregarTela() {
		...
		try {
			dataNascimento = getStringToDate(funcionario.getDataNascimento());
		...
		numero = funcionario.getEnderecoIdEndereco().getNumero() + "";
	...
	private void carregarTipoLogradouro() {
		...
		for (Logradouro l : Logradouro.values()) {
			listaTipoLogradouros.add(l.getTipoLogradouro());
		}
	}
